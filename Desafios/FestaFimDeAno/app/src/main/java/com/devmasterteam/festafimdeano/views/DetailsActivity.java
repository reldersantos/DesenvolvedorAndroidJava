    ...
    public void onClick(View view) {
        ...
        if (id == R.id.check_participate) {
            if (this.mViewHolder.checkParticipate.isChecked()) {
                this.mSecurityPreferences.storeString("presence_key", FimDeAnoConstants.CONFIRMED_WILL_GO);
            } else {
                this.mSecurityPreferences.storeString("presence_key", FimDeAnoConstants.CONFIRMED_WONT_GO);
            }
        }
    }
